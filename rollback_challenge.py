...
db.execute("CREATE TABLE IF NOT EXISTS history(time TIMESTAMP NOT NULL, tz_info TIMESTAMP NOT NULL," 
...
class Account(object):
    ...
    def _save_update(self, amount):
        ...
        timezone_information = Account._timezone_info()
        db.execute("UPDATE accounts SET balance=? WHERE name=?", (new_balance, self.name))
        db.execute("INSERT INTO history VALUES(?, ?, ?, ?)",
                   (transaction_time, timezone_information, self.name, amount))
        db.commit()
